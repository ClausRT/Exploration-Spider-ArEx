...
void loop() {
  ...
  for (int oi = 0; oi < 3; oi++){
   ...
   Serial.print(oi);
   Serial.print("]: ");
   Serial.print(Positions[oi][0]);
   Serial.print(", ");
   Serial.print(Positions[oi][1]);
   Serial.print(", ");
   Serial.print(Positions[oi][2]);
   Serial.println(".");
    ...
    do{
      ...
      Serial.println("Step all 8 legs");
